...
class Geeke {
  constructor(element, options, defaultStr='') {
    ...
    this.options = {
      ...
      defaultPlugins: ['inlineCode', 'escaper', 'header', 'boldItalic', 'bold1', 'bold2', 'italic1', 'italic2', 'link', 'strickethrough', 'seperator', 'seperator', 'highlight'],
  ...
  handleEditorClick(e) {
    console.log(this.cursor.getCurrentRange());
  }
}
