 ...
 *************************************************/
import {
  initPage as initPageMisc,
} from '../states/editorMisc';
import {
  initPage, setEditorState,
} from '../states/editor';
import {
...
const Geeke = () => {
  ...
  useEffect(() => {
    ...
    dispatcher.add(initPage, fakePageUuid)
              .add(setEditorState, fakePageUuid, EditorState.createWithContent(trimNumberListInWholePage(convertFromRaw(JSON.parse(testString)))))
              .run();
