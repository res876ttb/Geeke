...
import { BlockList, BlockTree } from '../utils/BlockTreeUtils';
          ...
          [
            {
              ...
              keyArray: ['4uump', '7tegj'],
              type: 'unstyled',
            },
          ],
          [],
        ],
        keyArray: ['6puud', 'dn4hc'],
        type: 'unstyled',
      },
      {
        indexHash: {
          ...
          [
            {
              ...
              valueArray: [[], []],
              keyArray: ['1960r', '368b5'],
              type: 'check-list',
            },
          ],
        ],
        keyArray: ['3vfhs', '5ur9n'],
        type: 'check-list',
      },
    ]);
